...
public class editTimeslot {
    ...
    void update(ActionEvent event) throws SQLException, IOException {
        ...
        if (result){
            ...
            stage.setTitle("Update Timeslot");
    ...
    void setData() throws SQLException{
        String id=indexTimetable.getSelecter();
        timeslot time=timeslot.findtimeslot(id);
        timeid.setText(id);
        subject.getSelectionModel().select(time.getSubject_id());
        day.getSelectionModel().select(time.getDate());
        from.getSelectionModel().select(time.getFrom());
        to.getSelectionModel().select(time.getTo());
    }
